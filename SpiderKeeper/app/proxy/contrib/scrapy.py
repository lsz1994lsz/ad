...
class ScrapydProxy(SpiderServiceProxy):
    ...
    def delete_project(self, project_name):
        ...
        if data and data['status'] == 'ok':
            print 'delete success:', project_name, data
        else:
            print 'delete fail:', project_name, data
    ...
    def start_spider(self, project_name, spider_name, arguments):
        print 'scrapy.start_spider'
        # print 'hi arguments', arguments
        print 'project_name', type(project_name), project_name
        print 'spider_name', spider_name
        url = arguments.get('url')
        time = arguments.get('time')
        post_data = dict(project=project_name, spider=spider_name, url=url, time=time)
