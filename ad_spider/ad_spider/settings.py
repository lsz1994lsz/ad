...
# Scrapy settings for ad_spider project
#
...
SPIDER_MODULES = ['ad_spider.spiders']
NEWSPIDER_MODULE = 'ad_spider.spiders'


#取消默认的useragent,使用新的useragent
DOWNLOADER_MIDDLEWARES = {
    'scrapy.contrib.downloadermiddleware.useragent.UserAgentMiddleware': None ,#关闭默认下载器
    'ad_spider.middlewares.JavaScriptMiddleware':500, #键为中间件类的路径，值为中间件的顺序
}
...
#USER_AGENT = 'ad_spider (+http://www.yourdomain.com)'
