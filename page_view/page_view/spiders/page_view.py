...
class PageViewSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        if readcount2.extract():
            print readcount2[3].extract()

        # 格隆汇
        # readcount3 = sel.xpath('//*[@id="content"]/div/div/div[1]/div[1]/div[2]/p[2]/span[1]/em[1]/text()')
        # print readcount3.extract()

        # 搜狐
        readcount4 = sel.xpath('//*[@id="article-container"]/div[2]/div[1]/div[3]/div[1]/span/em/text()')
        for i in readcount4:
            print i.extract()
